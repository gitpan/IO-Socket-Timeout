...
{
  $PerlIO::via::Timeout::Strategy::SelectWithReset::VERSION = '0.10';
}
...
use parent qw(PerlIO::via::Timeout::Strategy::Select);
...
PerlIO::via::Timeout::Strategy::SelectWithReset - like L<PerlIO::via::Timeout::Strategy::Select>, but ECONNRESET after timeout
...
=head1 SYNOPSIS
  ...
  timeout_strategy($fh, 'SelectWithReset', read_timeout => 0.5);

=head1 DESCRIPTION

This class implements a timeout strategy to be used by L<PerlIO::via::Timeout>.

This strategy is like L<PerlIO::via::Timeout::Strategy::Select> (it inherits
